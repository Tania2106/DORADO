<?php
session_start();
include'./php/conexion.php';//quite el primer punto
if(!isset($_SESSION['compra'])){header("Location: ./index.php");}
...
$conexion->query("insert into envios(direccion,estado,id_venta) values
(
  '".$_POST['c_address']."',
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Su orden fue completada.</p>
          </div>
        </div>
      </div>
    </div>
