...
if (isset($_GET['id'])) {
  ...
  if ($encontro == true) {
    ...
    //Si no esta el registro ejecuta esto:
 $nombre = "";
    $precio = "";
    $imagen = "";
  ...
  //sino existe, creamos la variable de session.
  if (isset($_GET['id'])) {
    $nombre = "";
    $precio = "";
    $imagen = "";
...
<html lang="en">
  ...
  <body style="background-color:rgb(252,243,207); font-family:times; color:#6C3483;">
            ...
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  $total =0;
                  if (isset($_SESSION['compra'])) {
                    $arregloCarrito =$_SESSION['compra'];
