...
<?php } ?>
       ...
       <table class="table">
         ...
         <tbody>
           ...
           <button class="btn btn-primary btn-small btn-small btnEditar"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nivel" placeholder="nivel" id="nivel" class="form-control">
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="telefono" placeholder="telefono" id="telefonoEdit" class="form-control">
          </div>

          <div class="form-group">
            <label for="emailEdit">Email</label>
            <input type="text" name="email" placeholder="email" id="emailEdit" class="form-control">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="nivel" placeholder="nivel" id="nivelEdit" class="form-control">
          </div>
