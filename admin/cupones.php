       ...
       <table class="table">
         ...
         <tbody>
           ...
           <td>
             ...
             <button class="btn btn-danger btn-small btn-small btnEliminar"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="row"></div>
            <div class="col 9">
            <input type="text" name="codigo" placeholder="codigo" id="codigo" class="form-control">
            </div>
            <div class="col-3">
          ...
          <div class="form-group">
            ...
            <input type="text" name="status" placeholder="status" id="status" class="form-control">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" min="0" name="valor" placeholder="valor" id="valor" class="form-control">
          </div>

          <div class="form-group">
            <label for="fecha">Fecha de vencimiento</label>
            <input type="date" min="0" name="fecha" placeholder="fecha" id="fecha" class="form-control">
          </div>
...
<div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="modalEliminarLabel">Eliminar Cupones</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
